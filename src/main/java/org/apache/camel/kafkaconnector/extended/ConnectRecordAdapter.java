...
public class ConnectRecordAdapter<R extends ConnectRecord<R>> implements JsonSerializer<R>, JsonDeserializer<R> {
    @Override
    ...
    public R deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
        ...
        try {
            return context.deserialize(element, Class.forName("org.apache.camel.kafkaconnector.extended." + type));
